...
function OperatorModal({ defaultFields, onSubmitFields, isMutating }) {
  ...
  return (
    <form className="section" onSubmit={handleSubmit(onSubmit, handleError)}>
      <h2 className="header">{isEditing ? 'Editar' : 'Agregar'} operador</h2>
      <div className="content">
        <div className="m-row">
          ...
          <FormInput
            ...
            name="description"
            rules={{
              required: 'Descripción no ingresado',

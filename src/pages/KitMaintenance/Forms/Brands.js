...
function BrandsModal({ defaultFields, onSubmitFields, isMutating }) {
  ...
  return (
    <form className="section" onSubmit={handleSubmit(onSubmit, handleError)}>
      <h2 className="header">{isEditing ? 'Editar' : 'Agregar'} Marca</h2>
      <div className="content">
        <div className="m-row">
          ...
          <FormInput
            ...
            name="description"
            rules={{
              required: 'Marca no ingresada',
              maxLength: { value: 50, message: 'La marca supera los 50 caracteres' }
            }}
          />
        </div>
      </div>
